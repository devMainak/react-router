...
export default function About(){
  return (
    ...
    <main className="container py-4">
      <h2 className="display-2 fw-normal">About Our Restaurants</h2>
      <p className="fs-5 fw-normal">Welcome to our restaurant guide! We are passionate about exploring and sharing culinary experiences from around the world. Our mission is to connect food lovers with the best dining options and unforgettable flavors.</p>
